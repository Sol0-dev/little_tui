...
_ENV_MAP = {
    ...
    "max_history_tokens": "LITTLE_TUI_MAX_HISTORY_TOKENS",
...
def _coerce(key: str, value: object) -> object:
    ...
    if key in ("max_steps", "max_history_tokens"):
...
def load_config() -> Config:
    ...
    data: dict[str, object] = {
        ...
        "max_history_tokens": resolve(
            "max_history_tokens", "max_history_tokens", DEFAULT_MAX_HISTORY_TOKENS
        ),
    ...
    return Config(
        ...
        max_history_tokens=int(coerced["max_history_tokens"]),
